import cv from '../documents/CV-Victoria Andrés.pdf';
import ecv from '../documents/CV-English.pdf';

export const Contact = () => {
  return (
    <div className="container d-flex flex-column align-items-center mt-5">

      <a href="mailto:vvictoriaandres@gmail.com" className="btn btn-light mt-3 mx-2 p-3 fs-5" style={{ background: '#d63384', color: 'white', maxWidth: '200px' }}> Enviame un email </a>

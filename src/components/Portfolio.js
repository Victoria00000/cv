              ...
              <div className='row'>
                ...
                <div className="cardbg-dark" style={{ width: '25rem' }}>
                  ...
                  <div className="card-body">
                    ...
                    <a href="https://github.com/Victoria00000/MoviesHouse" target="_blank" rel='noopener no referrer' className="btn btn-light mx-2" style={{ background: '#d63384', color: 'white' }}> GitHub </a>
                    <a href="https://trendingmovieshouse.netlify.app/" target="_blank" rel='noopener no referrer' className="btn btn-light mx-2" style={{ background: '#d63384', color: 'white' }}> Deploy </a>
                  </div>
                </div>
                ...
                <div className="cardbg-dark" style={{ width: '25rem' }}>
                  ...
                  <div className="card-body">
                    ...
                    <a href="https://github.com/Victoria00000/E-COMMERCE-APP" target="_blank" rel='noopener no referrer' className="btn btn-light mx-2" style={{ background: '#d63384', color: 'white' }}> GitHub </a>
                    <a href="https://velvety-starlight-bdc5ea.netlify.app/" target="_blank" rel='noopener no referrer' className="btn btn-light mx-2" style={{ background: '#d63384', color: 'white' }}> Deploy </a>
                  </div>
                </div>
